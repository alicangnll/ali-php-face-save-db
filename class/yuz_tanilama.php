...
namespace alicangonullu;

use YuzTanilama;
use alicangonullu\YuzBulunamadi;
...
class YuzTanila
{
     ...
     * @throws YuzTanilama
     */
    public function __construct($detection_data = 'algila.dat')
    {
        ...
        if (!is_file($detection_data)) {
            ...
            if (!is_file($detection_data)) {
                throw new \YuzTanilama("Algılama Dosyası Yüklenemedi");
            }
        }
    ...
    public function faceDetect($file)
    {
        if (is_resource($file)) {
            ...
            throw new YuzTanilama("Can not load $file");
        }
     ...
     *
     * @throws YuzBulunamadi
     */
    public function cropFaceToJpeg($outFileName = null)
    {
        if (empty($this->face)) {
            throw new YuzBulunamadi('No face detected');
        }
